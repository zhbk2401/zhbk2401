...
// src/utils/index.ts
import { createHmac, createHash } from "../../crypto-js/index.js";
...
var creatRequest = (config, logObj) => {
  ...
  instance.interceptors.response.use(
    (res) => {
      const responseTime = res.config?.headers?.Date ? parseInt(String(dayjs().valueOf())) - parseInt(res.config.headers?.Date) : null;
...
import dayjs2 from "../../dayjs/esm/index.js";
...
// src/web/Lan.ts
import { Bonjour } from "../../bonjour-service/dist/index.js";
...
import path from "https://github.com/nodejs/node/blob/v18.0.0/lib/path.js";
